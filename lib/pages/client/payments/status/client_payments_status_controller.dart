...
class ClientPaymentStatusControllers extends GetxController {
  MercadoPagoPayment mercadoPagoPayment =
      MercadoPagoPayment.fromJson(Get.arguments['mercadopago_payment']);
  var errorMessage = ''.obs;

  ClientPaymentStatusControllers() {
